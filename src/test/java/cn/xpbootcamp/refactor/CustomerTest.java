...
class CustomerTest {
    ...
    void should_return_correct_result_when_call_statement() {
        ...
        customer.addRental(new Campus(new Movie("同桌的你", CAMPUS), 4));
        customer.addRental(new NewRelease(new Movie("宠爱", NEW_RELEASE), 5));
        customer.addRental(new History(new Movie("战狼2", HISTORY), 6));
